...
public class AbstractVectorFloat implements Serializable{

    private static final long serialVersionUID = 5108626158054388650L;
    protected final float[] m_elements;
     ...
     */
    public AbstractVectorFloat( int size ){
     ...
     */
    public float[] get(){
        float[] elements = new float[m_elements.length];
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof AbstractVectorFloat)) {
            return false;
        }
        AbstractVectorFloat rhs = (AbstractVectorFloat) obj;
